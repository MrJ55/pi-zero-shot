...
Pi’s design philosophy strongly prefers a minimal core extended via skills, prompt templates, and packages rather than growing built-in multi-agent machinery.
